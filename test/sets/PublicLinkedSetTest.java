...
public class PublicLinkedSetTest {
  ...
  public void testIsSubset() {
    ...
    assertTrue(set5.isSubset(set4));
    assertTrue(set0.isSubset(set4));
    assertFalse(set5.isSubset(set1));
  }
  ...
  public void testUnionWithEmpty() {
    assertEquals(set1, set0.union(set2));
  }
...
@Test
  ...
  public void testIntersectWithDifferent() {
    assertEquals(0, set1.intersect(set5).size());
  }
...
public void testIntersectWithEmpty() {
  assertEquals(0, set1.intersect(set0).size());
}
